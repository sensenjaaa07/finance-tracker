...
import { faWallet, faGauge, faMoneyBill, faExchangeAlt, faMoneyBillTrendUp, faCoins } from '@fortawesome/free-solid-svg-icons'
    ...
    <aside className="navigation-container">
        ...
        <nav aria-label="Main navigation">
          <ul>
            ...
            <li><NavLink to="/income"><FontAwesomeIcon icon={faCoins} aria-hidden="true" /><span>Income</span></NavLink></li>
