...
var LayersText = ({ text: text$1, className, inverse, transform, style, ...attributes }) => {
	return makeReactConverter((0, import_react.useMemo)(() => {
		return text(text$1, {
...
var LayersCounter = ({ count, className, style, ...attributes }) => {
	return makeReactConverter((0, import_react.useMemo)(() => counter(count, { classes: className?.split(" ") }).abstract[0], [count, className]), {
		...attributes,
		style
	});
};
